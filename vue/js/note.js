...
function selectionnerHumeur(idHumeur){humeurSelectionnee=idHumeur;const fd=new FormData();fd.append("id_humeur",idHumeur);fetch("index.php?route=userHumeur",{method:"POST",body:fd}).then(()=>ouvrirModal());}
...
function enregistrerNote() {
  ...
  if(humeurSelectionnee){formData.append("id_humeur", humeurSelectionnee);}
